...
public class SignupOne extends JFrame implements ActionListener{
    ...
    long random;
    JTextField nameTextField, surnameTextField, fnameTextField, emailTextField, addressTextField, cityTextField, stateTextField, pinTextField;
    JButton next;
    ...
    SignupOne(){
        ...
        surname.setBounds(100, 190, 100, 30);
        add(surname);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("") || surname.equals("")){
                JOptionPane.showMessageDialog(null, "Name and Surname are Required");
            } else {
                Conn c = new Conn();
                String query = "insert into signup values('"+formno+"', '"+name+"','"+surname+"','"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+state+"', '"+pin+"')";
